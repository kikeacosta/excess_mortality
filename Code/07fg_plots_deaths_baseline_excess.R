...
db <- read_csv("Output/covid_excess_pclm_5.csv")
cts <- read_rds("Output/countries_to_include_excess.rds") %>% 
  pull(Country)
...
ggsave(here("Figures",
            "fig_s10_excess.png"), dpi = 600, width = 6, height = 6)
...
ggsave(here("Figures",
            "fig_s11_deaths_baseline.png"), dpi = 600, width = 6, height = 6)
